...
<body class="bg-slate-200">
    ...
    <div class="mt-4 bg-white p-4 container mx-auto">
        ...
        @else
            ...
            <form action="{{ route('pelanggaran.add.aksi', $kode_aksi) }}" method="POST">
                ...
                <button type="submit"
                    class="text-white mb-4 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 text-center ">
                    Tambah Pelanggaran
                </button>
            </form>
